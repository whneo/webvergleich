<table border="1">
    <thead>
        <tr>
            <th colspan="3">Wählen sie ein Element zum einlesen!</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td>
                <form action="index.php" method="POST">
                    ...
                    <input type="hidden" name="openHpiEinlesenSent" value="1" />
                </form>
            </td>
            <td>
            ...
            <td>
                <form action="index.php" method="POST">
                    ...
                    <input type="hidden" name="bbqEinlesenSent" value="1" />
                </form>
            </td>
        </tr>
        <tr>
            <td>
                <form action="index.php" method="POST">
                    ...
                    <input type="hidden" name="leitfadenFisiEinlesenSent" value="1" />
                </form>
            </td>
            <td>
                <form action="index.php" method="POST">
                    <input style="width: 100%" type="submit" value="IHK"></input>
                    <input type="hidden" name="ihkEinlesenSent" value="1" />
                </form>
            </td>
            <td>
                <form action="index.php" method="POST">
                    <input style="width: 100%" type="submit" value="Leitfaden FIAN"></input>
                    <input type="hidden" name="leitfadenFianEinlesenSent" value="1" />
                </form>
            </td>
        </tr>
        <tr>
